    ...
    <footer className='bg-black text-gray-300 pt-10 pb-5 px-[2%] md:px-[8%] xl:px-[12%]'>
      <div className='max-w-7xl mx-auto border-t border-gray-600'>
        <div className='grid md:grid-cols-3 gap-10 py-15'>
          <div className=''>
            <h3 className='text-white text-2xl font-semibold mb-3'>Informação</h3>
            <p className='text-gray-400'>
              Desde a fundação da nossa empresa, temos ajudado nossos clientes a encontrar soluções
              excepcionais <strong>para seus negócios.</strong> 
            </p>
          </div>
          {/* Get In Touch */}
          <div>
            <h3 className='text-white text-2xl font-semibold mb-3'>Entre em contato</h3>
            <p className='text-gray-400 mb-1'>
              Baird House, 15–17 St Cross St,<br />
              Londres EC1N 8UW
            </p>
            <p className='text-gray-400 mb-1'>+55 (81) 99999-9999</p>
