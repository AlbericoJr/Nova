...
export default function Nav() {
  ...
  return (
    <>
      <div
        className={`navbar h-[90px] flex justify-between items-center px-[2%] md:px-[8%] xl:px-[12%] fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          navBg ? "bg-white shadow-lg text-black" : "bg-transparent text-white"
        }`}
      >
        <Link
          to="/"
          className={`logo text-5xl font-bold transition-all duration-500 ${
      ...
      <div
        className={`fixed top-0 left-0 w-full h-screen backdrop-blur-sm bg-black/90 text-white px-[2%] md:px-[8%] xl:px-[12%] z-20 flex flex-col justify-center items-start transform transition-all duration-700 ease-[cubic-bezier(0.77, 0, 0.75, 1)] origin-top 
          ${
            menuOpen
          ...
          <li className="relative">
            ...
            >
              <li>
                <Link
                  to="/blog"
                  className="block text-4xl lg:text-4xl font-bold"
                  onClick={() => {
                    setMenuOpen(false)
                    setOpenDropdown("")
                  }}
              ...
              <li>
                <Link
                  to="/blog/1"
                  className="block py-2 text-4xl lg:text-4xl font-semibold"
                  onClick={() => {
                    setMenuOpen(false)
                    setOpenDropdown("")
                  }}
