...
import ser4 from '../assets/Images/serv-icon4.png'
    ...
    <>
        ...
        {services.map((services, index) =>(
          ...
          >
            ...
            >
              ...
              <p className='text-xl'>
              Desenvolver websites é muito mais do que marketing; é também estética.
              </p>
            </div>
      ...
      <div className='about py-[8%] px-[2%] md:px-[8%] xl:px-[12%] flex justify-between items-star lg:flex-row flex-col gap-10'>
        <div className='about-content w-full lg:w-[60%]'>
          <span className='text-black bg-primary px-2 py-3 font-semibold text-md sm:text-xl rounded-sm'>Bem-vindos à Nova</span>
          ...
          <ul className='flex xl:flex-nowrap flex-wrap gap-5 lg:gap-10'>
            <li className='w-full xl:w-1/2'>
              <span className='font-semibold text-2xl text-white'>Nossa Missão</span>
              <p className='text-md sm:text-md mt-2 text-gray-300'>
                Desde o momento em que nossa empresa foi fundada, temos ajudado nossos clientes a encontrar <b>soluções excepcionais para seus negócios</b> marcas memoráveis e produtos digitais. Nossa expertise cresce a cada ano, assim como nossa experiência acumulada.
              </p>
            </li>
            
            <li className='w-full xl:w-1/2'>
              <span className='font-semibold text-2xl text-white'>Nosso Objetivo</span>
              <p className='text-md sm:text-md my-2 text-gray-300'>
                Nosso objetivo é entregar experiências incríveis que façam as pessoas falarem, e construir valor estratégico para marcas, tecnologia e entretenimento.
              </p>
          ...
          <div className='flex items-center justify-center w-[250px] h-[250px] relative border rounded-full'>
            ...
            >
              ...
              >
                ...
                ANOS DE EXPERIÊNCIA EM SOLUÇÕES DIGITAIS . ANOS DE EXPERIÊNCIA EM SOLUÇÕES DIGITAIS . 
                </textPath>
              </text>
